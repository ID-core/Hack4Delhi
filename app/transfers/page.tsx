  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-4xl font-bold text-slate-900">Transfer Requests</h1>
          <p className="text-slate-600 mt-2 font-medium">Request location transfers and track approvals</p>
        </div>
